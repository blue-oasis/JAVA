...
//코드 공유
// 모든 도시 쌍에는 연결하는 유일한 경로있음, 길이 가중치있음
// 두 도시 연결하는 경로 상에서 가장 짧은 도로 길이, 가장 긴 도로 길이 구하기
// 입력 도시수 N
// N-1줄 A B C => A와 B사이 길이 C도로, 양의정수
// 다음 줄 질의 수 K
// D E => 두 도시 
//연결하는 최단 도로 길이. 최대 도로 길이 출력

import java.util.*;
import java.io.*;

public class 백준_3176_도로네트워크 {
    ...
    public static void main(String[] args) throws Exception {
        System.setIn(new FileInputStream("ex01/src/삼성SDS알고리즘/day8/input_3176.txt"));
